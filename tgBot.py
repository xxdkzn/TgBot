...
@bot.message_handler(state=MyStates.target_word, func=lambda message: message.text != Command.NEXT)
...
@bot.message_handler(state=MyStates.translate_word, func=lambda message: message.text != Command.NEXT)
